...
{
    /// <summary>
    /// ServiceEventSource class.
    /// </summary>
    [EventSource(Name = "NetCore-Packaging-WorkItemService")]
    internal sealed class ServiceEventSource : EventSource, IServiceEventSource
    {
        ...
        // For more information see https://msdn.NetCore.com/en-us/library/system.diagnostics.tracing.eventsource.aspx
